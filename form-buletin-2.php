...
<body>
    ...
    <div class="container">
        ...
        <div class="kotak-form">
            <form action="upload-buletin.php" method="post" enctype="multipart/form-data">
                <table>
                    <tr>
                        <td class="label">
                            <label for="image">Tambahkan disain sampul buletin.</label>
                            <p>Ukuran file maksimal adalah 500KB.</p>
                            <p>File yang diterima adalah png, jpg, dan jpeg.</p>
                        </td>
                    </tr>
                    <tr>
                        <td>
