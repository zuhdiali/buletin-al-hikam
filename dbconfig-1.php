<?php
    ...
    $db_database = "mhs_222011642";     // Write your own db name here
    $db_username = "222011642";      // Write your own username here
    $db_password = "WantWore091";          // Write your own password here
